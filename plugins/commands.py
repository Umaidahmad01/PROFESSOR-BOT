...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('📢 Uᴩᴅᴀᴛᴇꜱ 📢', url=f'https://t.me/anime_movie_society')
            ],[
            InlineKeyboardButton('⚡ Hᴇʟᴩ ⚡', url=f"https://t.me/ahss_help_zone")
        ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/TEAM_SOCIETY_1")
            ],[      
